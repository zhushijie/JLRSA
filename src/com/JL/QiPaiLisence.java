...
public class QiPaiLisence {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //String decoderData=JLRSACoder.decryptData(encoderData,pubKeyBase64str);
        ...
        FileOutputStream oFile = new FileOutputStream("lisence_jipaiqi.properties", false);//true表示追加打开


        prop.setProperty("Product.hardwarekey", datamap.get("Product.hardwarekey").toString());
        prop.setProperty("Product.version", datamap.get("Product.version").toString());
        prop.setProperty("License.type", datamap.get("License.type").toString());
